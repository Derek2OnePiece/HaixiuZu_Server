...
| created_ts | Long | timestamp | |
| user_level | Int | 5 | 0 - 9 |

| name | String | | init from douban |
| avatar | String | | |
| avatar_tiny | String | | |
| photo_wall | String | | list to string |
| photo_wall_tiny | String | | list to string |

| loc_city_id | String | | tencent city id |
| loc_city_name | Strng | | tencent city name |
| geo_enabled | Int | 0 | 1: enable |
